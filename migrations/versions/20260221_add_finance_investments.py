...
def upgrade():
    ...
    op.execute(sa.text("CREATE INDEX IF NOT EXISTS ix_finance_investments_tenant_id ON finance_investments (tenant_id)"))
    op.execute(sa.text("CREATE INDEX IF NOT EXISTS ix_finance_investments_company_id ON finance_investments (company_id)"))
    op.execute(sa.text("CREATE INDEX IF NOT EXISTS ix_finance_investments_account_id ON finance_investments (account_id)"))
