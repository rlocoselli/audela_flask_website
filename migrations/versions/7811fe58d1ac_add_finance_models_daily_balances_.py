...
def upgrade():
    ...
    op.create_index(op.f('ix_finance_products_code'), 'finance_products', ['code'], unique=False)
    op.create_index(op.f('ix_finance_products_category_id'), 'finance_products', ['category_id'], unique=False)
    op.create_index(op.f('ix_finance_products_gl_account_id'), 'finance_products', ['gl_account_id'], unique=False)
    op.create_index(op.f('ix_finance_products_tenant_id'), 'finance_products', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_finance_daily_balances_account_id'), 'finance_daily_balances', ['account_id'], unique=False)
    op.create_index(op.f('ix_finance_daily_balances_balance_date'), 'finance_daily_balances', ['balance_date'], unique=False)
    op.create_index(op.f('ix_finance_daily_balances_tenant_id'), 'finance_daily_balances', ['tenant_id'], unique=False)
    op.create_index('ix_fin_daily_balance_account_date', 'finance_daily_balances', ['account_id', 'balance_date'], unique=False)
    ...
    op.create_index(op.f('ix_finance_adjustments_account_id'), 'finance_adjustments', ['account_id'], unique=False)
    op.create_index(op.f('ix_finance_adjustments_category_id'), 'finance_adjustments', ['category_id'], unique=False)
    op.create_index(op.f('ix_finance_adjustments_counterparty_id'), 'finance_adjustments', ['counterparty_id'], unique=False)
    op.create_index(op.f('ix_finance_adjustments_gl_account_id'), 'finance_adjustments', ['gl_account_id'], unique=False)
    op.create_index(op.f('ix_finance_adjustments_tenant_id'), 'finance_adjustments', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_finance_adjustment_logs_adjustment_id'), 'finance_adjustment_logs', ['adjustment_id'], unique=False)
    op.create_index(op.f('ix_finance_adjustment_logs_tenant_id'), 'finance_adjustment_logs', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_finance_counterparty_attributes_counterparty_id'), 'finance_counterparty_attributes', ['counterparty_id'], unique=False)
    op.create_index(op.f('ix_finance_counterparty_attributes_tenant_id'), 'finance_counterparty_attributes', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_finance_gocardless_connections_account_id'), 'finance_gocardless_connections', ['account_id'], unique=False)
    op.create_index(op.f('ix_finance_gocardless_connections_company_id'), 'finance_gocardless_connections', ['company_id'], unique=False)
    op.create_index(op.f('ix_finance_gocardless_connections_tenant_id'), 'finance_gocardless_connections', ['tenant_id'], unique=False)
    ...
    op.create_index(op.f('ix_finance_gocardless_sync_logs_connection_id'), 'finance_gocardless_sync_logs', ['connection_id'], unique=False)
    op.create_index(op.f('ix_finance_gocardless_sync_logs_tenant_id'), 'finance_gocardless_sync_logs', ['tenant_id'], unique=False)
