...
def products():
    ...
    has_ml = SubscriptionService.check_feature_access(current_user.tenant_id, "ml")
    ...
    if not has_finance and not has_bi and not has_ml and not has_credit and not has_ifrs9 and not has_project:
