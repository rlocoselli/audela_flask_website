...
PRODUCT_CATALOG: dict[str, dict[str, Any]] = {
    "finance": {
        ...
        "image": "images/products/finance.svg",
    ...
    "ml": {
        "public_title": "Produit ML Studio",
        "meta_description": "ML Studio AUDELA: entraînez, testez et déployez des modèles de machine learning à partir de vos sources BI, avec suivi et gouvernance dans une interface unifiée.",
        "subtitle": "Du dataset BI au modèle déployé, dans un même studio.",
        "overview": "AUDELA ML Studio réutilise vos sources BI pour construire des modèles prédictifs, comparer des algorithmes, gérer le cycle de vie et diffuser des prédictions en production.",
        "image": "images/products/ml.svg",
        "image_alt": "Image du produit ML Studio",
        "features": [
            "Sélection d'algorithmes et entraînement supervisé sur données BI.",
            "Évaluation sur jeu de test avec métriques de performance.",
            "Déploiement contrôlé des modèles et scoring en continu.",
            "Versioning, historique d'exécution et gouvernance MLOps.",
        ],
        "integrations": [
            "Connexion directe à toutes les sources SQL/API déjà configurées dans BI.",
            "Pipelines ETL et préparation de données en continuité avec l'écosystème BI.",
            "Intégration MLflow embarquée pour tracking, registry et suivi des runs.",
        ],
        "use_cases": [
            "Prévision de ventes, coûts et cashflow à partir de l'historique BI.",
            "Scoring client, churn, fraude et alertes prédictives métiers.",
            "Industrialisation de modèles data science pour équipes opérationnelles.",
        ],
        "outcomes": [
            "Mise en production plus rapide des modèles grâce à un flux unifié.",
            "Comparaison fiable des algorithmes avec mesures traçables.",
            "Décisions augmentées par des prédictions contextualisées.",
        ],
        "audience": "Data analysts, data scientists, équipes BI et métiers décisionnels.",
        "plans_cta": "Découvrir les plans ML Studio",
        "plans_slug": "ml",
        "tenant_title": "AUDELA ML Studio",
        "tenant_summary": "Studio Machine Learning connecté aux sources BI pour entraîner, tester, déployer et servir des modèles prédictifs.",
        "tenant_access_label": "Accéder à ML Studio",
        "tenant_access_disabled": "Accès ML Studio désactivé",
    },
    "credit": {
        "public_title": "Produit Audela Credit",
        "meta_description": "Solution AUDELA Credit pour l'origination bancaire: borrowers, deals, facilities, collatéraux, garants, ratios, credit memo et workflow d'approbation.",
        "subtitle": "Origination de crédit pour petites banques, de l'analyse au comité de décision.",
    ...
    "ifrs9": {
        "public_title": "Produit IFRS9",
        "meta_description": "Module IFRS9 pour expected credit loss: staging, gouvernance des hypothèses, calcul ECL et exports d'audit pour le risque de crédit.",
        "subtitle": "Provisionnement IFRS9 (ECL) intégré à votre univers crédit.",
        "overview": "Le module IFRS9 apporte un socle de provisionnement ECL avec règles de staging, paramètres de risque et piste d'audit pour les revues risque et finance.",
        "image": "images/products/ifrs9.svg",
        "image_alt": "Image du produit IFRS9",
        "features": [
            "Activation IFRS9 par abonnement avec contrôle strict des accès.",
            "Espace dédié pour staging, paramètres et calcul ECL (MVP en cours).",
            "Structure prête pour lier borrowers, deals, facilities et ratios existants.",
            "Périmètre conçu pour traçabilité et futures exigences d'audit.",
        ],
        "integrations": [
            "Réutilisation des données Audela Credit (borrowers, deals, facilities, ratios).",
            "Activation par feature flag has_ifrs9 au niveau plan d'abonnement.",
            "Déploiement progressif sans impacter les modules Finance/BI/Project.",
        ],
        "use_cases": [
            "Préparer un MVP IFRS9 sans créer une application séparée.",
            "Activer IFRS9 uniquement pour les tenants ayant acheté le module.",
            "Industrialiser ensuite PD/LGD/EAD et moteurs de scénario macro.",
        ],
        "outcomes": [
            "Mise en service rapide d'un socle IFRS9 dans l'architecture existante.",
            "Réduction du risque de dérive grâce à un périmètre dédié.",
            "Trajectoire claire vers un moteur ECL complet.",
        ],
        "audience": "Directions risques, crédit et finance en préparation IFRS9.",
        "plans_cta": "Découvrir les plans IFRS9",
        "plans_slug": "ifrs9",
        "tenant_title": "AUDELA IFRS9",
        "tenant_summary": "Socle IFRS9 activable par plan, avec espace dédié pour staging et ECL.",
        "tenant_access_label": "Accéder à IFRS9",
        "tenant_access_disabled": "Accès IFRS9 désactivé",
    },
    "project": {
        ...
        "image": "images/products/project.svg",
