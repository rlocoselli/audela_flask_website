    ...
    def get_tenant_stats(tenant_id: int) -> SimpleNamespace:
        ...
        if subscription:
            ...
            stats.update({
                ...
                "has_ml": bool((subscription.plan.features_json or {}).get("has_ml", bool(subscription.plan.has_bi) or subscription.plan.code == "free")) if isinstance(subscription.plan.features_json, dict) else bool(subscription.plan.has_bi or subscription.plan.code == "free"),
