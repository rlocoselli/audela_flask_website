...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "es": {
        ...
        "Workflows salvos": "Workflows guardados",
        "Salvar workflow": "Guardar workflow",
        "Nome do workflow": "Nombre del workflow",
        "Salvar cria JSON + YAML quando o fluxo é válido.": "Guardar crea JSON + YAML cuando el flujo es válido.",
        "Conexões": "Conexiones",
        "Use o catálogo para selecionar DB/API. Credenciais são armazenadas criptografadas.": "Use el catálogo para seleccionar BD/API. Las credenciales se almacenan cifradas.",
        ...
        "Formato": "Formato",
        "Ações": "Acciones",
        "Adicionar passos": "Agregar pasos",
        "Preview": "Vista previa",
        "Preview (últimos resultados)": "Vista previa (últimos resultados)",
        "Dica: campos JSON devem ser um JSON válido (ex: {\"Authorization\":\"Bearer ...\"}).": "Consejo: los campos JSON deben ser un JSON válido (p. ej., {\"Authorization\":\"Bearer ...\"}).",
        "DB Sources": "Fuentes de BD",
        "API Sources": "Fuentes API",
        "Use existing sources catalog. Click plug icon to test connection.": "Usa el catálogo de fuentes existente. Haz clic en el icono del enchufe para probar la conexión.",
    ...
    "it": {
        ...
        # ETL Builder
        "ETL Builder": "Costruttore ETL",
        "ETLs": "ETL",
        "Novo workflow": "Nuovo workflow",
        "Workflows salvos": "Workflow salvati",
        "Salvar workflow": "Salva workflow",
        "Nome do workflow": "Nome del workflow",
        "Salvar cria JSON + YAML quando o fluxo é válido.": "Il salvataggio crea JSON + YAML quando il flusso è valido.",
        "Conexões": "Connessioni",
        "Use o catálogo para selecionar DB/API. Credenciais são armazenadas criptografadas.": "Usa il catalogo per selezionare DB/API. Le credenziali sono memorizzate criptate.",
        ...
        "Formato": "Formato",
        "Ações": "Azioni",
        "Adicionar passos": "Aggiungi passi",
        "Preview": "Anteprima",
        "Preview (últimos resultados)": "Anteprima (ultimi risultati)",
        "Dica: campos JSON devem ser um JSON válido (ex: {\"Authorization\":\"Bearer ...\"}).": "Suggerimento: i campi JSON devono essere un JSON valido (es: {\"Authorization\":\"Bearer ...\"}).",
        "DB Sources": "Sorgenti DB",
        "API Sources": "Sorgenti API",
        "Use existing sources catalog. Click plug icon to test connection.": "Usa il catalogo delle sorgenti esistente. Clicca sull’icona della spina per testare la connessione.",
    ...
    "de": {
        ...
        "Workflows salvos": "Gespeicherte Workflows",
        "Salvar workflow": "Workflow speichern",
        "Nome do workflow": "Workflow-Name",
        "Salvar cria JSON + YAML quando o fluxo é válido.": "Speichern erzeugt JSON + YAML, wenn der Flow gültig ist.",
        "Conexões": "Verbindungen",
        "Use o catálogo para selecionar DB/API. Credenciais são armazenadas criptografadas.": "Nutzen Sie den Katalog, um DB/API auszuwählen. Anmeldedaten werden verschlüsselt gespeichert.",
        ...
        "Preview": "Vorschau",
        "Preview (últimos resultados)": "Vorschau (neueste Ergebnisse)",
        "Dica: campos JSON devem ser um JSON válido (ex: {\"Authorization\":\"Bearer ...\"}).": "Tipp: JSON-Felder müssen gültiges JSON sein (z. B. {\"Authorization\":\"Bearer ...\"}).",
        "DB Sources": "DB-Quellen",
        "API Sources": "API-Quellen",
        "Use existing sources catalog. Click plug icon to test connection.": "Verwenden Sie den bestehenden Quellenkatalog. Klicken Sie auf das Stecker-Symbol, um die Verbindung zu testen.",
